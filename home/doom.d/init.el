...
(doom! :input
       ...
       (opacity)           ; HACK custom package for opacity control. flags: +onstartup
       ...
       (org +roam2 +pretty +pomodoro +gnuplot +dragndrop +brain)               ; organize your plain life in plain text
