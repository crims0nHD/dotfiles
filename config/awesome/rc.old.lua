...
globalkeys =
    ...
    awful.key(
        ...
        "j",
        function()
            decrement_screen_on_client(client.focus)
        end,
    ...
    awful.key(
        ...
        "k",
        function()
            increment_screen_on_client(client.focus)
        end,
    ...
    awful.key(
        ...
        "e",
        function()
            awful.util.spawn(start_emacsclient_cmd)
        end,
    ...
    awful.key(
        ...
        "w",
        function()
            awful.spawn(rofi_window_switch_cmd)
        end,
    ...
    awful.key(
        ...
        "v",
        function()
            awful.spawn(rofi_vm_connect_cmd)
        end,
